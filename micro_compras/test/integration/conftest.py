...
async def test_session_factory(test_engine):
    """Crea una factory de sesiones de prueba."""
...
@pytest.fixture
async def app_with_test_db(test_engine, test_session_factory):
    ...
    # Override de la dependencia get_current_user para tests
    def mock_get_current_user(request: Request):
        """Mock que extrae info de headers de test."""
    ...
    # Override de dependencia de autenticación
